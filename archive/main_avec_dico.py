...
nbMotif18 = 0#int(input('[18] Motif :')) Motif AH
nbMotif19 = int(input('[19] Motif :'))
nbMotif20 = int(input('[20] Motif :'))
nbMotif21 = int(input('[21] Motif :'))
nbMotif22 = int(input('[22] Motif :')) 
...
for i in range(nbMotif19):     # 
    BH()
for i in range(nbMotif20):     
    BI()
for i in range(nbMotif21):     
    BC()
for i in range(nbMotif22):     
    BD()
