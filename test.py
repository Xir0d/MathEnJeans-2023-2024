...
# Définir le coin inférieur gauche de la grille
coin_inferieur_gauche_x = -250
coin_inferieur_gauche_y = -250

# Déplacer la tortue au coin inférieur gauche de la grille
tortue.penup()
tortue.goto(coin_inferieur_gauche_x, coin_inferieur_gauche_y)
tortue.pendown()

# Exemple : dessiner un carré à partir du coin inférieur gauche
